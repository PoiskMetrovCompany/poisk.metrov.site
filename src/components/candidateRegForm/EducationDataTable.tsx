...
const EducationDataTable: FC<IEducationDataTableProps> = ({
  index,
  formData,
  setFormData,
}) => {
          ...
          <tr>
            <td colSpan={2}>
              <input
                ...
                onChange={(e) =>
                  handleInputChange(`nameInstitution${index}`, e.target.value)
                }
              />
            </td>
          </tr>
          <tr>
            <td>
              <input
                ...
                onChange={(e) =>
                  handleDateChange(`dateOfEntrance${index}`, e.target.value)
                }
              />
            </td>
            <td>
              <input
                ...
                onChange={(e) =>
                  handleDateChange(`dateOfEnding${index}`, e.target.value)
                }
              />
            </td>
          </tr>
          <tr>
            <td>
              <input
                ...
                onChange={(e) =>
                  handleInputChange(`typeOfEducation${index}`, e.target.value)
                }
              />
            </td>
            <td>
              <input
                ...
                onChange={(e) =>
                  handleInputChange(`diplomaSpeciality${index}`, e.target.value)
                }
              />
            </td>
          </tr>
