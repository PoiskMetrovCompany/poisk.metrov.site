  ...
  return (
    <div className={styles.carousel}>
      <div className={styles.carousel__navigation}>
        <button className={`${styles.carousel__button} ${styles.carousel__button__prev}`} onClick={prevSlide}>
        ...
        <button className={`${styles.carousel__button} ${styles.carousel__button__next}`} onClick={nextSlide}>
          <svg fill="#000000" width="18.67px" height="18.67px" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg" id="arrow">
