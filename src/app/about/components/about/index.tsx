  ...
  return (
    <div className={styles.about}>
      ...
      <div className={styles.about__container}>
        <IconImage
          className={styles.about__container__info}
          iconLink="/images/about/house-about.webp"
          alt="about"
        />
        <div className={styles.about__container__cols}>
          <div className={styles.about__container__col_left}>
            <div
              className={clsx(
                styles.about__container__col_left__block,
                styles.about__container__col_left__block_1
              )}
            >
              ...
              <div className={styles.about__container__col_left__block__text}>
                ...
                >
                  ...
                  ребрендинг, обновили подход, и вышли на новый уровень. Сейчас
                  в нашей команде уже более 150 сотрудников в Новосибирске.
                </p>
              </div>
            </div>
            <div
              className={clsx(
                styles.about__container__col_left__block,
                styles.about__container__col_left__block_2
              )}
            >
              <span className={styles.about__container__col_left__block__count}>
                3 /
          ...
          <div className={styles.about__container__col_right}>
            <div
              className={clsx(
                styles.about__container__col_right__block,
            ...
            >
              ...
              <div className={styles.about__container__col_right__block__text}>
                ...
                >
                  ...
                  выбора жилья. Планируем выход в новые города, улучшение поиска
                  и добавление онлайн-инструментов, чтобы всё можно было решить
                  в одном месте.
                </p>
              </div>
            </div>
