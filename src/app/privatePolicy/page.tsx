...
import H2 from "@/components/ui/heading2"
import P from "@/components/ui/Paragragraph"
import CustomLink from "@/components/ui/Link"
import OL from "@/components/ui/numberedList"
import UL from "@/components/ui/bulletList"

import AL from "@/components/ui/alphabeticList"
const PrivacyPolicyPage = () => {
  return (
    <div className={styles.private_policy}>
      <H1>Политика в отношении обработки персональных данных</H1>
      <div className={styles.private_policy__content}>
        <div className={styles.section}>
          <H2>1. Общие положения</H2>
          <P>
            Настоящая политика обработки персональных данных составлена в соответствии с требованиями Федерального закона от 27.07.5006. №152-ФЗ «О персональных данных» (далее - Закон о персональных данных) и определяет порядок обработки персональных данных и меры по обеспечению безопасности персональных данных, предпринимаемые ИП Плющиков Дмитрий Алексеевич (далее – Оператор).
          </P>
          <OL>
            ...
            <CustomLink href="https://poisk-metrov.ru">
              https://poisk-metrov.ru
            </CustomLink>
            .</li>
          </OL>
        </div>
        ...
        <div className={styles.section}>
          <H2 marginTop={50}>2. Основные понятия, используемые в Политике</H2>
          <OL>
            ...
            <li>Веб-сайт – совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу{" "}
            <CustomLink href="https://poisk-metrov.ru">
              https://poisk-metrov.ru
            </CustomLink>
            .</li>
            ...
            <li>Персональные данные – любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта{" "}
            <CustomLink href="https://poisk-metrov.ru">
              https://poisk-metrov.ru
            </CustomLink>
            .</li>
            ...
            <li>Пользователь – любой посетитель веб-сайта{" "}
            <CustomLink href="https://poisk-metrov.ru">
              https://poisk-metrov.ru
            </CustomLink>
            .</li>
        ...
        <div className={styles.section}>
          <H2 marginTop={50}>3. Основные права и обязанности Оператора</H2>
          <P>1. Оператор имеет право:</P>
          <UL>
        ...
        <div className={styles.section}>
          <H2 marginTop={50}>4. Основные права и обязанности субъектов персональных данных</H2>
          
          <P>1. Субъекты персональных данных имеют право:</P>
          <UL>
          ...
          <P>2. Субъекты персональных данных обязаны:</P>
          <UL>
        ...
        <div className={styles.section}>
          <H2 marginTop={50}>5. Оператор может обрабатывать следующие персональные данные Пользователя</H2>
          <OL>
        ...
        <div className={styles.section}>
          <H2 marginTop={50}>6. Принципы обработки персональных данных</H2>
          <OL>
        ...
        <div className={styles.section}>
          <H2 marginTop={50}>7. Цели обработки персональных данных</H2>
          <OL>
        ...
        <div className={styles.section}>
          <H2 marginTop={50}>8. Правовые основания обработки персональных данных</H2>
          <OL>
            ...
            <li>Оператор обрабатывает персональные данные Пользователя только в случае их заполнения и/или отправки Пользователем самостоятельно через специальные формы, расположенные на сайте{" "}
            <CustomLink href="https://poisk-metrov.ru">
              https://poisk-metrov.ru
            </CustomLink>
            {" "}или направленные Оператору посредством электронной почты. Заполняя соответствующие формы и/или отправляя свои персональные данные Оператору, Пользователь выражает свое согласие с данной Политикой.</li>
        ...
        <div className={styles.section}>
          <H2 marginTop={50}>9. Условия обработки персональных данных</H2>
          <OL>
       ...
       <div className={styles.section}>
          <H2 marginTop={50}>10. Порядок сбора, хранения, передачи и других видов обработки персональных данных</H2>
          <P>
          ...
          <OL>
            ...
            <li>В случае выявления неточностей в персональных данных, Пользователь может актуализировать их самостоятельно, путем направления Оператору уведомление на адрес электронной почты Оператора centrnovostroyek@yandex.ru с пометкой «Актуализация персональных данных».</li>
            ...
            Пользователь может в любой момент отозвать свое согласие на обработку персональных данных, направив Оператору уведомление посредством электронной почты на электронный адрес Оператора centrnovostroyek@yandex.ru с пометкой «Отзыв согласия на обработку персональных данных».</li>
        ...
        <div className={styles.section}>
          <H2 marginTop={50}>11. Перечень действий, производимых Оператором с полученными персональными данными</H2>
          <OL>
        ...
        <div className={styles.section}>
          <H2 marginTop={50}>12. Трансграничная передача персональных данных</H2>
          <OL>
        ...
        <div className={styles.section}>
          <H2 marginTop={50}>13. Конфиденциальность персональных данных</H2>
          <P>
        ...
        <div className={styles.section}>
          <H2 marginTop={50}>14. Заключительные положения</H2>
          <OL>
            <li>Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты centrnovostroyek@yandex.ru.</li>
            ...
            <CustomLink href="https://poisk-metrov.ru/policy">
              https://poisk-metrov.ru/policy
            </CustomLink>
            .</li>
          </OL>
        </div>
