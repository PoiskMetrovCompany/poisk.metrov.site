...
const SecurityRegForm: FC = () => {
  ...
  const [showPasswordCheckmark, setShowPasswordCheckmark] =
    ...
    try {
      ...
      if (response.data.request && response.data.attributes) {
        ...
        if (response.data.attributes.access_token) {
          ...
          console.log(
            "Токен администратора сохранен в cookie:",
  ...
  const handleSubmit = async (
    ...
    if (isFormValid()) {
      ...
      const success = await sendAuthRequest(
        loginValue.trim(),
        passwordValue.trim()
      )
        ...
        <section style={{ padding: "0", maxWidth: "440px" }}>
          <div className="center-card">
            ...
            <p style={{ maxWidth: "100%" }}>
              Введите логин и пароль, чтобы авторизоваться в системе и получить
            ...
            >
              <div className="input-container" style={{ marginBottom: "20px" }}>
                <label htmlFor="login" id="formLabel" className="formLabel">
                  Логин
                </label>
                <input
                  type="text"
            ...
            <a href="#" style={{ display: "none" }} id="changeNumber">
              Изменить номер
            </a>
          </div>
        </section>
